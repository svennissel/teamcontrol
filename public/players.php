                        ...
                        <div class="club-admin-actions">
                            ...
                            <?php if ($isClubAdmin): ?>
                                <form action="action.php" method="POST" class="inline-form" onsubmit="confirmDelete(event, 'Soll dieser Spieler wirklich gelöscht werden?')">
                                    ...
                                    <button type="submit" class="delete-btn" id="delete-player-btn" title="Löschen"><i class="fa-solid fa-trash"></i></button>
                                </form>
                            <?php endif; ?>
                        </div>
                    </div>
                    <div class="card-details">
                        ...
                        <?php if ($player['hash']):
                            ...
                            <div class="copy-link-row">
                                ...
                                <button type="button" class="edit-btn" onclick="copyToClipboard('login-link-<?php echo $player['id']; ?>')" title="Link kopieren"><i class="fa-regular fa-clipboard"></i></button>
